...
import {
  FaChartPie,
  FaNetworkWired,
  FaUsers, // Changed from FaChartPie for better clarity
  FaFilter,
} from "react-icons/fa";
...
const featuresData = [
  {
    ...
    titleKey: 'embedded_form',
    descriptionKey: 'embedded_form_description',
    href: '/feature5',
  },
  {
    icon: <FontAwesomeIcon icon={faMousePointer} />,
    titleKey: 'drag_drop_builder',
    descriptionKey: 'drag_drop_builder_description',
    href: '/feature5',
  },
  {
    icon: <FaChartPie />,
  ...
  {
    // Using a more intuitive icon for segmentation
    icon: <FaUsers />,
    titleKey: 'list_segmentation',
    descriptionKey: 'list_segmentation_description',
    href: '/feature5',
  },
  {
    icon: <FaNetworkWired />,
  ...
  return (
    ...
    <div className={`py-16 sm:py-24 bg-gray-50 ${isRTL ? 'rtl' : ''}`}>
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* --- Step 2: Integrated Header Section for a better layout --- */}
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            {t('all_tools_title')}
          </h2>
          <p className="mt-4 text-lg text-gray-600">
            {t('all_tools_description')}
          </p>
        </div>
