...
const Automation = () => {
  return (
    ...
    {/* Left Side Content */}
    <div className="md:w-1/2 mt-0 relative left-20 lg:mt-10 text-left">
      <h1 className='font-semibold w-[272px] rounded-md p-2 bg-bkg mb-2'>INTEGRATED EMAIL TRACKER 🎯</h1>
      ...
      Collect actionable data
        ...
        <h2 className="text-4xl sm:text-40px font-semibold text- leading-tight relative inline-block">from your emails</h2>
      <p className="mt-4 text-lg text-gray-700">
     
      Track your email marketing campaign results in<br />real-time through advanced email analytics.
      </p>
      <ul className="mt-6 space-y-4">
        <li className="flex items-start">
          ...
          <span className="text-black font-medium">
            ...
            Real-Time Data: </span><span className='font-normal'> Monitor campaign performance as it <br /> happens.</span>
          </span>
        </li>
        <li className="flex items-start">
          <span className="text-white mr-3 mt-2 p-xs rounded-full bg-lgreen">
          ...
          <span className="text-black font-medium">
            <strong>Comprehensive Insights:  </strong> <span className="font-normal">Analyze opens, clicks, bounces,<br /> and more.</span>
          </span>
        </li>
        <li className="flex items-start">
          <span className="text-white mr-3 mt-2 p-xs rounded-full bg-lgreen">
          ...
          <span className="text-gray-800 font-medium">
            <strong>Visual Reports : </strong><span className="font-normal text-base"> Easy-to-understand charts and graphs.</span>
          </span>
        </li>
